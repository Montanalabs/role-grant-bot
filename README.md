...
- `role-grant-bot_safe.wave` — the correct design.
- `role-grant-bot_unsafe.wave` — the tempting-but-wrong version (the negative example a model must learn to reject).
